...
Route::get('/specific_category/{id}', [MainController::class, 'SpecificCategory']);
Route::get('/specific_company/{id}', [MainController::class, 'SpecificCompany']);
...
Route::get('/admin', [AdminController::class, 'Admin_Dashboard_Page']);
...
Route::get('/company_table', [AdminController::class, 'company_Table']);
...
Route::get('/admin_company_shop/{id}', [AdminController::class, 'Admin_company_Shop']);
