...
<section class="cart-total-page spad">
    <div class="container shadow  shadow-lg border border-secondary p-5">
                    ...
                    <div class="order-table">
                        ...
                        @foreach ($cartData as $value)
                            ...
                            <div class="cart-item">
                                ...
                                <p class="product-name">{{ $value->price * $value->quantity }}</p>
                            </div>
                        @endforeach
                        <div class="cart-item">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="payment-method">
                        ...
                        <button type="submit"  onmouseover="this.style.background='#3acf87'">Place your order</button>
                    </div>
                </div>
            </div>
        </form>
