...
<body>
    ...
    <section class="nav-bar fixed-top shadow shadow-sm">
        <div class="nav-container">
            <a href="{{ URL::to('home') }}">
                <p class="brandd " style="color: black; font-weight: bold"> Motors by SFA </p>
            </a>
                    ...
                    @else
                        ...
                        <li>
                            ...
                            <ul class="nav-dropdown">
                                <li>
                                    <a href="{{ URL::to('loginascustomer') }}">as a Customer of Car</a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('loginasowner') }}">as a Owner of Car</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav-dropdown">
                                <li>
                                    <a href="{{ URL::to('signupasuser') }}">as a Customer of Car</a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('signupasowner') }}">as a Owner of Car</a>
                                </li>
