                        ...
                        <div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ URL::to('add_company') }}" method="post">
                                        @csrf
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label style="color:black">Enter Company name</label>
                                                <input type="text" name="company" class="form-control border-dark">
                            ...
                            <tbody>
                                ...
                                @foreach ($allCompanies as $value)
                                    <tr style="color:black">
                                        ...
                                        <td><a href="{{ URL::to('/admin_company_shop/' . $value->makeid) }}"
