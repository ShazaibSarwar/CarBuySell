                ...
                <tbody>
                    ...
                    @foreach ($allProducts as $value)
                        <tr style="color:black">
                            ...
                            <td class="text-capitalize" style=" display:inline-block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 40ch;">{{ $value->details }}</td>
                            <td class="text-capitalize">{{ $value->subcatname }}</td>
                            <td class="text-capitalize">{{ $value->quantity }}</td>
                            <td><img src="{{ URL::asset('img/' . $value->img1) }}" width="150px" alt=""></td>
