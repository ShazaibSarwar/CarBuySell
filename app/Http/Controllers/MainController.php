...
class MainController extends Controller
{
    ...
    public function SpecificCategory($id)
    {
        ...
        $pro = products::all()->where('subcatid', $id);
        // $subcat = subcategories::find($pro->subcatid);

        return view('website.specific_category', compact('pro',  'c','subcat',  'product' ));
    }
    ...
    public function SpecificCompany($id)
    {
        ...
        // DB::table('users')->where('active', false);
        $pro = products::all()->where('make', $id);
        // $subcat = subcategories::find($pro->subcatid);

        return view('website.specific_company', compact('pro',  'c','subcat',  'product' ));
    }
    ...
    public function CancelBooking($id, $proid, $customeremail)
    {
        if (!session()->has('customer_id')) {
            ...
            // Mail::to('info.shasar@gmail.com')->send(new sendcontactmail($cancelorder));
